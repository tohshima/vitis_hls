...
void start_tasks(
    ...
    #pragma HLS STREAM variable=peripheral_waddr_out depth=4
    hls_thread_local hls::stream<word_t> peripheral_wdata_out;
    #pragma HLS STREAM variable=peripheral_wdata_out depth=4
    hls_thread_local hls::stream<addr_t> dispadr_out;
    #pragma HLS STREAM variable=dispadr_out depth=4
    hls_thread_local hls::stream<word_t> dispdat_out;
    #pragma HLS STREAM variable=dispdat_out depth=4
